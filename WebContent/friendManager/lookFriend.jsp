    ...
    <body bgcolor="CCCFFF">
        ...
        <div align="center">
            <table border="0" cellspacing="0"cellpadding="0" width="100%"align="center">
                <tr>
                    <td width="20%">
                        <a href="http://localhost:8080/PIMS/friendManager/addFriend.jsp">增加联系人</a>
                    </td>
                    <td width="20%">
                        查看通信录
                    </td>
                    <td width="20%">
                        <a href="http://localhost:8080/PIMS/friendManager/updateFriend.jsp">修改联系人</a>
                    </td>
                    <td width="20%">
                        <a href="http://localhost:8080/PIMS/friendManager/deleteFriend.jsp">删除联系人</a>
                    </td>
                </tr>
            </table>
        </div>
